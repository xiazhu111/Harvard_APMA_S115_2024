...
[s,i,r]=census1D(pop);
results=[s,i,r]; %start the results matrix. Results matrix is # timesteps (rows) x # individuals in each of s,i,r states (columns)
tt=t;
while i>0 %iterate over discrete timesteps until no infected individuals remain
