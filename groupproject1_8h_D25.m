...
clearvars
close all
clc %this one doesn't run past 1st dose, as bacteria grows out of control. To see results, type horzcat(t1,y1)
...
D1 = 25; %use molecules of amoxicillin - units need to match that of bacteria. assume 50 molecules = 500 mg dose, since 
