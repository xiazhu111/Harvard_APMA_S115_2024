...
D1 = 50; %use molecules of amoxicillin - units need to match that of bacteria. assume 50 molecules = 500 mg dose, since 
...
l = 0; %before add in for loop
    tend = 240; %240 minutes = 4 hours, cut 8 hour recommended period between doses in half
